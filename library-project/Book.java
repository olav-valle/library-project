...
public class Book
{
    ...
    String bookPublisher, String publishingDate, String bookPages, String ean13)
    {
    ...
    public String getRefNumber() { return ean13; }
    ...
    /** A very crude way of allowing String method contains() to be used as search function on ALL fields at once
